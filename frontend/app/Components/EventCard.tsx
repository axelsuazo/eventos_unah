...
export default function EventCard({ event, onOpen }: EventCardProps) {
  ...
  return (
    <article
      ...
      className="group flex h-full cursor-pointer flex-col overflow-hidden rounded-[0.5rem] bg-white shadow-lg ring-1 ring-gray-200 transition hover:-translate-y-1 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-[#183972]/20 dark:bg-slate-900 dark:ring-slate-700"
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <span
          className={`absolute right-4 top-45 rounded-full px-3 py-1 text-xs font-black shadow-sm ring-1 ${getModalityBadgeClass(
            event.modality,
          )}`}
        >
